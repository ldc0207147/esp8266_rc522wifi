...
$sql = "SELECT * FROM cardlist"; // sql語法存在變數中
...
<div class="dashboard">
		...
		<nav>
			<section class="dicover">
				...
				<ul>
					...
					<li>
						<a href="cardlist.php" class="active">
	...
	<main class="content-wrap">		
        ...
        　	<div style="width:70%;height:20px;margin:0 auto;">
			<h1 class="margin_top50">卡片管理</h1>
			<div class="text-left">
            <button class='btn btn-info' onclick="window.alert('功能開發中');">新增卡片</a>
			</div>
                ...
                <tbody>
                    <tr class="table-danger">
                        ...
                        for ($i = 0; $i < $datas_len; $i++) {
                            echo "<tr>";
                            echo "<td>" . ($i + 1) . "</td>";
                            echo "<td>" . $datas[$i]['cardhex'] . "</td>";
							echo "<td>" . $datas[$i]['cardname'] . "</td>";
                            echo "<td>
                            <button class='btn btn btn-warning'>修改</button>
