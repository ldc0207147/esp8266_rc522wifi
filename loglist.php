...
$sql = "SELECT * FROM locklog"; // sql語法存在變數中
...
<div class="dashboard">
	...
	<main class="content-wrap">		
        ...
        　	<div style="width:70%;height:20px;margin:0 auto;">
			<h1 class="margin_top50">Log紀錄</h1>
			<div class="text-left">
            <button class='btn btn-warning' onclick="location.reload();">刷新</a>
			</div>
            <table class="table table-hover margin_top50" id="list_table">
                ...
                <tbody>
					<tr class="table-danger">
					  ...
					  // 根据 "datetime" 字段逆向排序
					  usort($sortedDatas, function($a, $b) {
					  ...
					  for ($i = 0; $i < $datas_len; $i++) {
						echo "<tr>";
						echo "<td>" . ($i + 1) . "</td>";
						echo "<td>" . $sortedDatas[$i]['card'] . "</td>";
						echo "<td>" . $sortedDatas[$i]['state'] . "</td>";
						echo "<td>" . $sortedDatas[$i]['datetime'] . "</td>";
						echo "<td></td>";
						echo "</tr>";
					  }
					  ?>
